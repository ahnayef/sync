...
type ResolvedScheduleRow = RawScheduleRow & {
...
function parseWorksheet(sheet: ExcelJS.Worksheet) {
...
async function parseWorkbook(buffer: Buffer, fileName: string, worksheetGid?: string | null) {
...
async function fetchGoogleSheetBuffer(input: string): Promise<DownloadedSheet> {
...
async function applyRows(rows: ResolvedScheduleRow[]) {
